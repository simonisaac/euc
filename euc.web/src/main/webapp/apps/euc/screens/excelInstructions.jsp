...
<head>
	...
	<script type="text/javascript" src="../../../js/euc/screens/excelInstructions.js"></script>
	...
	<script type="text/javascript">
		...
		<%
			String excelNodeType = request.getParameter("excelNodeType");
			if (excelNodeType == null) {
		        out.println("No Excel Node Type supplied");
		    } else {
		        //
		    }
		%>
	
		var excelNodeTypeDyn = "<%=excelNodeType%>";
